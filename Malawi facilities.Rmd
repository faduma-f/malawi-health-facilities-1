...
plot_ownership_MFL = ggplot(ownership_MFL, aes(x=Var1, y=Freq, fill=Var1)) + geom_bar(stat = "identity")
plot_ownership_MFL = plot_ownership_MFL + scale_fill_brewer(palette="Dark2") + labs(x = "Ownership", y = "Frequency") + coord_flip()
plot_ownership_MFL
```
