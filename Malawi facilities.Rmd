...
plot_facility_types_MFL = plot_facility_types_MFL + labs(x = "Facility types", y = "Frequency", fill="Ownership") + scale_fill_brewer(palette = "Set2") + coord_flip() + theme_pubclean() + theme(legend.title = element_text(size = 9), legend.text = element_text(size = 9))
...
plot_facility_types_WHO = plot_facility_types_WHO + labs(x = "Facility types", y = "Frequency", fill="Ownership") + scale_fill_brewer(palette = "Set2") + coord_flip() + theme_pubclean() + theme(legend.title = element_text(size = 9), legend.text = element_text(size = 9))
...
### MFL
class(malawi_facilities_MFL$TYPE)

malawi_facilities_MFL$TYPE = as.factor(malawi_facilities_MFL$TYPE)

malawi_facilities_MFL$TYPE = factor(malawi_facilities_MFL$TYPE, levels = c("Central Hospital", "District Hospital", "Hospital", "Health Centre", "Clinic", "Health Post", "Dispensary", "Private", "Unclassified")) # re-ordering the levels 

### WHO
class(map_static_WHO$facility_type_9)

map_static_WHO$facility_type_9 = as.factor(map_static_WHO$facility_type_9)

map_static_WHO$facility_type_9 = factor(map_static_WHO$facility_type_9, levels = c("Hospital", "Community Health Unit", "Health Centre", "Health Clinic", "Health Post")) # re-ordering the levels
