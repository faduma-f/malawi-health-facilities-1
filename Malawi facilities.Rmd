...
plot_facility_types_MFL = ggplot(facility_types_MFL, aes(x=Var1, y=Freq)) + geom_bar(stat = "identity", fill = "springgreen4")
plot_facility_types_MFL = plot_facility_types_MFL + labs(x = "Facility types", y = "Frequency") + coord_flip()
...
plot_ownership_MFL = ggplot(ownership_MFL, aes(x=Var1, y=Freq)) + geom_bar(stat = "identity", fill = "springgreen4")
plot_ownership_MFL = plot_ownership_MFL + labs(x = "Ownership", y = "Frequency") + coord_flip()
plot_ownership_MFL
```
