...
malawi_rhs = malawi_rhs[-c(3, 36, 45, 50, 56, 66, 70, 103, 106, 126, 165, 183, 215), ]
```
...
```{r Private MFL, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r Blantyre, echo=FALSE, message=FALSE, warning=FALSE}
...
tmap_private_blantyre = tm_shape(filter(malawi_admin2, shapeName == "Blantyre")) + tm_borders() + tm_shape(filter(private_intersect_admin2_MFL, shapeName == "Blantyre")) + tm_dots(size = 0.3) + tm_layout(title = "Private facilities")
...
tmap_hosp_blantyre = tm_shape(filter(malawi_admin2, shapeName == "Blantyre")) + tm_borders() + tm_shape(blantyre_hosp_intersect_admin2_MFL) + tm_dots(col = "hospital", palette="red", title = "MFL hospitals", size = 0.3) + tm_shape(blantyre_hosp_intersect_admin2_rhs) + tm_dots(col = "amenity",title = "healthsites.io amenity tag", palette="darkgreen", size = 0.3)
...
tmap_hosp_health_blantyre = tm_shape(filter(malawi_admin2, shapeName == "Blantyre")) + tm_borders() + tm_shape(blantyre_hosp_intersect_admin2_MFL) + tm_dots(col = "hospital", palette="red", title = "MFL hospitals", size = 0.3) + tm_shape(blantyre_health_intersect_admin2_rhs) + tm_dots(col = "healthcare",palette="darkgreen", title = "healthsites.io healthcare tag", size = 0.3)
# 21 in healthsites 
